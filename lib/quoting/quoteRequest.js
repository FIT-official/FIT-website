 ...
 *   them from the stored model bytes and ignores browser measurement differences
...
export const QuoteInputSchema = z
  .object({
    ...
    selection: z.object({ filament: z.enum(['pla', 'pla_matte', 'petg', 'asa', 'abs', 'tpu']),
      colour: z.string().min(1).max(80) }).strict().optional(),
