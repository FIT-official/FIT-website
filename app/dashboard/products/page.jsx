    ...
    return (
        <div className='flex w-full flex-col h-[92vh] py-20 border-b border-borderColor px-8'>
            <div className='flex w-full items-end justify-between'>
                <h1>Products</h1>
                <Link href='/dashboard/products/create' className='border border-borderColor rounded-sm font-normal flex items-center py-1 pl-4 pr-2'>
                    Create
                    <GoPlus className='ml-2' size={20} />
                </Link>
            </div>
